...
try:
    ...
    _import_structure["pipeline_stable_diffusion_inpaint_mixed_context"] = ["StableDiffusionInpaintMixedContextPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_inpaint_mixed_context import StableDiffusionInpaintMixedContextPipeline
